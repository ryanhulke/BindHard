...
def train():
    ...
    # TargetDiff: 9 layers, hidden_dim=128, n_heads=16, k=32
    GAT_HIDDEN_DIM = 128
    GAT_NUM_LAYERS = 9
    GAT_N_HEADS = 16
    ...
    run_name = "gat_egnn_diffusion"
    wandb_kwargs = dict(project=cfg.project, entity=cfg.entity, name=run_name, config={
        **cfg.__dict__,
        "denoiser": "GATEGNN",
